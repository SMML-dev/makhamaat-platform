...
import { Settings, X, Tag, Layers, FileText, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-brand-green/5 rounded-bl-[3rem] -mr-10 -mt-10"></div>
            ...
            <div className="flex items-center mb-8 relative z-10">
              <div className="w-12 h-12 bg-brand-green/10 rounded-xl flex items-center justify-center text-brand-green mr-4 shadow-inner">
                <Settings size={24} />
              </div>
              <h3 className="text-2xl font-black text-brand-dark tracking-tight">{t('admin.edit_product_title', 'Modifier le Produit')}</h3>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-5 relative z-10">
              <div>
                ...
                <div className="relative">
                  <Tag className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-green" size={18} />
                  <input
                    required
                    type="text"
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-brand-green/10 outline-none font-bold text-brand-dark transition-all placeholder-gray-300"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-brand-green/10 outline-none font-bold text-brand-dark appearance-none"
                    value={form.category}
              ...
              <div>
                ...
                <div className="relative">
                  <AlertCircle className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-green" size={18} />
                  <input
                    type="number"
                    className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-brand-green/10 outline-none font-black text-brand-dark transition-all"
                    value={form.minStock}
              ...
              <div>
                ...
                <div className="relative">
                  <FileText className="absolute left-4 top-4 text-brand-green" size={18} />
                  <textarea
                    rows={2}
                    className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-brand-green/10 outline-none font-bold text-brand-dark placeholder-gray-300 resize-none"
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-[2] py-4 bg-brand-green text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-brand-green/20 hover:bg-green-700 transition-all active:scale-95 flex items-center justify-center space-x-2"
                >
                  <CheckCircle size={18} />
                  <span>{t('common.save_changes', 'Enregistrer')}</span>
                </button>
              </div>
            </form>
          </motion.div>
